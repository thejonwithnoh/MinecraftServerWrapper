...
public class Player extends AbstractInvoker
{
	 ...
	 * @param  console
	 *         the console associated with this player
	 */
	 ...
	 * 
	 * @param   message
	 *          the message to send to this player
	 * @param   color
	 *          the color that the sent message should appear in
	 * @return  the full text of the tellraw command used to send the message
	 */
	 ...
	 * 
	 * @param   json
	 *          the json which will be passed to the tellraw command
	 * @return  the full text of the tellraw command used to send the message
	 */
