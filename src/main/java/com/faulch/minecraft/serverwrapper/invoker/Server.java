...
public class Server extends AbstractInvoker {
	 ...
	 *
	 * @param console the console associated with this server
	 */
	 ...
	 *
	 * @param message the message to print to the specified stream
	 * @param stream  the stream to have the specified message printed to
