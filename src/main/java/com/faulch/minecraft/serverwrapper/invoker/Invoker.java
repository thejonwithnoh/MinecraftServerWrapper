...
public interface Invoker {
	 ...
	 *
	 * @param command a command to be executed by this invoker
	 ...
	 *
	 * @param message a message to be sent to this invoker
	 * @return the value passed to this method as a convenience
	 */
	 ...
	 *
	 * @param message an error message to be sent to this invoker
	 * @return the value passed to this method as a convenience
	 */
