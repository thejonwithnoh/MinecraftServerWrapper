...
public class LineEmitter
{
	 ...
	 * 
	 * @param   line
	 *          the line of text to emit to all attached line processors
	 ...
	 * 
	 * @param   lineProcessor
	 *          the line processor to append to the end of the processing list
	 ...
	 * 
	 * @param   lineProcessor
	 *          the line processor to remove from the processing list
