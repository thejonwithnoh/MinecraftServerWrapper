...
public final class Utility {
	 ...
	 *
	 * @param directory the directory to search for files within
	 * @param pattern   the pattern to match files against
	 * @return an array of files loaded from the given directory matching the
	 * given pattern
	 */
	public static File[] getFiles(File directory, final Pattern pattern) {
	 ...
	 *
	 * @param files the jar files to be loaded
	 * @return a <code>URLClassLoader</code> using the provided jar files
	 * @throws MalformedURLException if the files given somehow don't convert to URLs
	 */
	public static URLClassLoader createURLClassLoader(File... files) throws MalformedURLException {
	 ...
	 * interface.
	 *
	 * @param object the object which represents a resource for which closing should
	 *               be attempted
	 * @return the exception generated by attempting to close the resource, or
	 * <code>null</code> if no exception was generated
	 */
	public static Exception tryClose(Object object) {
		try {
			if (object != null) {
	 ...
	 *
	 * @param value the <code>String</code> value which will be converted into an
	 *              object of type <code>type</code>
	 * @param type  the type of object that <code>value</code> should be converted
	 *              into
